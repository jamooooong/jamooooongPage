        ...
        <div className="flex sm:flex-row flex-col">
          ...
          <div className="flex flex-col mt-20 sm:mt-0 sm:w-2/3 sm:ml-auto gap-12">
            ...
            <div className="flex sm:flex-row flex-col w-full gap-4">
              <img src="https://github.com/user-attachments/assets/449f96ae-404f-4e93-ab1c-cf686bd89c08" />
            ...
            <div className="flex sm:flex-row flex-col w-full gap-4">
              <img src="https://github.com/user-attachments/assets/ad5ac71a-3f71-45ba-a100-cb198a4dcca3" />
              <div className="flex flex-col gap-4">
                <p className=" text-xl font-bold">기계 만지기?</p>
                <p className=" text-base text-gray_02">
                  어릴때부터 기계를 만지고 뜯어보는 걸 좋아했어요. 컴퓨터
                  조립하고, 부품들 만지는거 좋아해요. 가끔은 차도 뜯습니다..
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="sm:w-3/5 mx-auto px-3">
          <div className="flex sm:flex-row flex-col">
            <div className="flex flex-col mt-20 sm:mt-0 sm:w-2/3 sm:ml-auto gap-12">
              ...
              <div className="flex sm:flex-row flex-col w-full gap-4">
                <img src="https://github.com/user-attachments/assets/4b2c9d0c-1d6c-47bb-b382-6e00d13cce62" />
                <div className="flex flex-col gap-4">
